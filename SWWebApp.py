...
if selected == "Home":
    ...
    reviews = ["Amazing quality and great prices!", "Fast shipping and excellent customer service.", "Highly recommended!", "I didn't know what to buy my mum for her birthday but the k means algorithm helped me find the perfect gift", "Wow the product reccomendation on this webapp is amazing", "I wanted to buy one pair of shoes and I ended up buying 3 shirts, 2 pairs of jeans and 4 pairs of shoes thanks to the reccomendations", "this k means algorithm is amazing"]
    st.write(reviews)
